...
const Map = compose(
  ...
  return (
    <GoogleMap
      ...
      defaultCenter={{ lat: -7.5568463, lng:
        width < 600
          ? 110.9106694
          : 600 < width < 720
            ? 110.9106694
    ...
    >
      <Marker position={{ lat: -7.557286, lng: 110.7943181 }} label="The Sunan Hotel" onClick={() => window.open("https://www.google.com/maps/place/The+Sunan+Hotel/@-7.5577948,110.7941942,15.9z/data=!4m12!1m6!3m5!1s0x2e7a16912e502e11:0xf9e5a89a42aab736!2sThe+Sunan+Hotel!8m2!3d-7.5573252!4d110.794305!3m4!1s0x2e7a16912e502e11:0xf9e5a89a42aab736!8m2!3d-7.5573252!4d110.794305")}>
        <InfoBox
          visible={width > 720}
      ...
      <Marker position={{ lat: -7.5596031, lng: 110.8400508 }} label="Universitas Sebelas Maret (UNS)" onClick={() => window.open("https://www.google.com/maps/place/Sebelas+Maret+University/@-7.5603858,110.8560903,15.93z/data=!4m5!3m4!1s0x2e7a14234667a3fd:0xbda63b32997616ad!8m2!3d-7.5596031!4d110.8565448")}>
        <InfoBox
          visible={width > 720}
          onCloseClick={() => console.log('Hiphophile')}
          options={{ closeBoxURL: ``, enableEventPropagation: true }}>
          <a
            ...
            rel="noopener noreferrer">
            <div className={styles.infoBoxContainer}>
              <Text heading5Alt className={styles.venue} component="p">Universitas Sebelas Maret (UNS)</Text>
              <footer className={styles.infoFooter}>
                View on Map
                <Arrow className={styles.arrow} />
              </footer>
