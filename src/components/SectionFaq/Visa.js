  ...
  return (
    <section style={{maxWidth: '720px', paddingTop: '64px', position: 'relative'}}>
      ...
      <Text medium component="p" style={{marginBottom: '0'}}>
        If you need a visa, please fill up the form (<strong><a href="https://www.indonesia.travel/gb/en/trip-ideas/visa-free-for-169-countries-to-travel-to-indonesia" rel="noopener noreferrer" target="_blank">get the form here</a></strong>) and send it to the Secretariat at <strong><a href="mailto:info@civicengagementforum.net">info@civicengagementforum.net</a></strong> together with your passport copy (photo page).
