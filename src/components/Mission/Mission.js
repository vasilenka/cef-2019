        ...
        <main>
          ...
          <div className={styles.double}>
            <section className={styles.section}>
              <Text heading3Alt component="h3" style={{marginBottom: '12px'}}>Urban Focus</Text>
            ...
            <section className={styles.section}>
              <Text heading3Alt component="h3" style={{marginBottom: '12px'}}>“Four Point Zero”</Text>
              <Text medium component="p" style={{ marginBottom: 0 }}>
                <strong>Civic Engagement 4.0</strong> alludes to the Fourth Industrial Revolution, which is triggering “a technological revolution that will fundamentally alter the way we live, work, and relate to one another” (Klaus 2016). Citizens can make use of new digital technologies to become more active and engage in meaningful participation to work towards a dignified, just, and sustainable society. Civic Engagement 4.0, however, does not single-mindedly celebrate or promote the benefits of technology, but rather challenges to contemplate and articulate how core values such as dignity and justice can be enabled and how the promises of sustainability can be fulfilled in the era of technology. The 2019 International Forum in Solo encourages participants to analyze both the potential and dangers of new forms of technologies, while making use of digital activism and virtual collaboration.
              </Text>
            </section>
          </div>
        </main>
