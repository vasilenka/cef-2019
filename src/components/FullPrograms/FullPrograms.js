    ...
    <Dialog>
      <header
        style={{
          ...
          top: 0,
          padding: "12px 0px",
          backgroundColor: "#E8C23D",
          boxShadow: "0px 16px 32px -12px rgba(0,0,0,.24)",
        }}>
        <Container narrow>
          <Box alignCenter>
            <Button
            ...
            <a
              href="https://drive.google.com/uc?authuser=0&id=12nrgQ2C_qlQu1WZ3DrF8D6QGAC6gtk13&export=download"
      ...
      <main>
        <Container bleed>
          <iframe
            ...
            src="https://drive.google.com/file/d/12nrgQ2C_qlQu1WZ3DrF8D6QGAC6gtk13/preview"
            width="100%"
