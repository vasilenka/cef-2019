...
const FullPrograms = ({
  ...
  return (
    <Dialog>
      <header style={{  position:'sticky', top: 0, padding: '12px 0px', backgroundColor: '#E8C23D', boxShadow: '0px 16px 32px -12px rgba(0,0,0,.24)' }}>
        <Container narrow>
          <Box alignCenter>
            ...
            <a href="https://drive.google.com/uc?authuser=0&id=1XxjvtOL_pSxpCe8_hfn4OVoUjVHXH5lC&export=download" rel="noopener noreferrer" target="_blank">
      ...
      <main>
        <Container bleed>
          <iframe title="Full programs pdf" src="https://drive.google.com/file/d/1XxjvtOL_pSxpCe8_hfn4OVoUjVHXH5lC/preview" width="100%" style={{ height: 'calc(100vh - 72px)'}}>
