        ...
        description={
          <>
            <Text medium component="p">
              ...
              on anti-human trafficking in the Mekong Sub-Region. In August
              2018, she received the distinguished award from the Department of
              Special Investigation (DSI), Ministry of Justice, Thailand; the
              Network Model Award 2018 in saluting her collaboration with DSI to
              accentuate the prevention and protection of the organised crime in
              Thailand and Southeast Asian region.
            </Text>
            <Text medium component="p">
              Previously, Dr. Ratchada Jayagupta was a National Programme
              Officer for Governance CEDAW (Convention on the Elimination of All
              Forms of Discrimination Against Women) Southeast Asia Programme at
              UN WOMEN regional office for Asia and the Pacific. She was also a
              National Project Coordinator of United Nations Inter- Agency
              Project on Human Trafficking in the Mekhong Sub-Region
              (UNIAP-Thailand Office). Dr. Ratchada received her Ph.D. in
              Development Administration at the National Institute for
              Development Administration (NIDA), Thailand (international
              program). She was a visiting fellow at University of Oxford during
              her dissertation development in 2006. She was an elected Member of
              Executive Committee for 11th International Association for the
              Study of Forced Migration (IASFM) International Conference
              (2006-2008), and an appointed Member of Program Committee for 9th
              and 10th IASFM International Conference (2003-2006).
            </Text>
          </>
        }
      />
        ...
        description={
          <>
            ...
            <Text medium component="p">
              ...
              learning processes, farmers are able to expand their agricultural
              knowledge and create positive change.
            </Text>
            <Text medium component="p">
              With a concrete basis in sustainable agriculture, farmers have
              also developed alternative market strategies, including Fair Trade
              and local green markets. Connecting the organic farmers’ movement
              to national policy debates and works to reform government policy
              to support small farmers and the community rights. Strengthening
              the urban people to access self-reliance on food and food safety.
              And campaigning to build awareness about Thailand’s changing food
              system, urban livelihood and the urban environmental problem.
              Provide the platform for urban people to support the farmers on
              food sovereignty.
            </Text>
          </>
        }
        ...
        description={
          <>
            ...
            <Text medium component="p">
              ...
              revitalization, bio-cultural diversity, and peoples’ stories. His
              recent publications include “Plants, Animals, Salt, and Spirits:
              How People Live with and Talk about the Environment” (With Bampen
              Chaiyarak, in Militante et al. eds. Humanity and Nature:
              Traditional, Cultural, and Alternative Perspectives, Focus on the
              Global South, 2016), “Cheum Chong: Outcomes and Challenges of
              Chong Language Revitalization Project” (In Premsrirat &amp; Hirsh
              eds. Language Revitalization: Insights from Thailand. Peter Lang,
              2018), and Motion Event Expression of So, a Marginal Language in
              Sakhon Nakhon Province in Northeast Thailand (Ph.D. thesis,
        ...
        description={
          <>
            ...
            <Text medium component="p">
              ...
              her research on cultural expressions by, for, and about women and
              marginalized communities. She is co-editing the Routledge Handbook
              of Religion and Cities and also working on her first book,
              Building Justice: Theological Commitments in Architectural Design,
              which is about Christian values in architecture.
            </Text>
            <Text medium component="p">
              Dr. Edwards serves her local community and broader academic
              community through numerous leadership roles in Creative Waco, the
        ...
        description={
          <>
            <Text medium component="p">
              ...
              economic development and civic engagement. She was an Economist at
              Asian Development Bank (ADB) in the Philippines, working in Laos,
              Vietnam, Cambodia, Pakistan and Thailand from 2002 to 2007. During
              2009-2012, Dr. Lewis did qualitative studies in several provinces
              in rural Thailand in research supported by the TRF and the
              Fulbright New Century Scholars Program. The two projects are “A
              Study on Implementing a Self-Assessment Tool of Community based
              Microfinance Organizations” and “Weather Index Insurance: Bringing
              Security to Thai Farmers”. From 2012-2013, she served as an
              International Microfinance Specialist and Team Leader of an ADB
              Technical Assistance: Developing a Strategic Framework for
              Financial Inclusion in Thailand, and led a team of international
              and national consultants to develop a national strategy for
              financial inclusion. Recently, Dr. Lewis is the leader of a large
              research project funded by Chulalongkorn University to develop
